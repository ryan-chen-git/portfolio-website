    ...
    <main className="max-w-lg mx-auto py-12 px-4">
      ...
      <div className="space-y-4">
        <div className="p-6 border border-gray-800 rounded-lg hover:border-gray-700 hover:bg-gray-900/50 transition-all duration-300 transform hover:scale-[1.02] text-center fade-in">
          <a href="https://www.linkedin.com/in/ryan-z-chen" className="flex items-center justify-center gap-3 text-sm hover:text-gray-400 transition-colors group">
        ...
        <div className="p-6 border border-gray-800 rounded-lg hover:border-gray-700 hover:bg-gray-900/50 transition-all duration-300 transform hover:scale-[1.02] text-center fade-in">
          <a href="mailto:ryanchen@berkeley.edu" className="flex items-center justify-center gap-3 text-sm hover:text-gray-400 transition-colors group">
            <svg className="w-5 h-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
            ...
            <span>ryanchen@berkeley.edu</span>
          </a>
        </div>
        <div className="p-6 border border-gray-800 rounded-lg hover:border-gray-700 hover:bg-gray-900/50 transition-all duration-300 transform hover:scale-[1.02] text-center fade-in">
          <a href="https://github.com/ryan-chen-git" className="flex items-center justify-center gap-3 text-sm hover:text-gray-400 transition-colors group">
            <svg className="w-5 h-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
